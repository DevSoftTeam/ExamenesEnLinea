 ...
 * UserAnswer
 *
 * @ORM\Table(name="user_answer", uniqueConstraints={@ORM\UniqueConstraint(name="user_answer_pk", columns={"id_user_answer"})}, indexes={@ORM\Index(name="respondio_fk", columns={"id_test_taken", "id_user", "id_test"}), @ORM\Index(name="relationship_12_fk", columns={"id_question"})})
 * @ORM\Entity
 */
class UserAnswer
{
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="id_test_taken", referencedColumnName="id_test_taken"),
